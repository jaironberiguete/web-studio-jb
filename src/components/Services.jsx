    ...
    <section id="services" className="py-20">
      <div className="max-w-6xl mx-auto px-6 ">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6 ">
          <div className="p-6 rounded-lg shadow-sm bg-red-700 text-white ">
            <h3 className="font-semibold">Starter Website</h3>
            <p className="mt-2 text-sm text-gray-300">1-3 pages, contact form, Google Maps.</p>
            <div className="mt-4 font-bold">$300–$500</div>
          </div>

          <div className="p-6 bg-white rounded-lg border bg-rose-600/10">
          ...
          <div className="p-6 rounded-lg shadow-sm bg-red-700 text-white ">
            ...
            <p className="mt-2 text-sm text-gray-300">Booking, payments, admin dashboard.</p>
